...
//			 x.style.display = "none";
			 ...
			 data.addColumn('string', 'Period'); // Implicit domain label// col.
		     data.addColumn('number', 'Total Messages'); // Implicit// series 1 data// col.
		     data.addColumn('number', 'Response Time (Hours)'); // Implicit// series 1// data col.
