...
public class DataLossPreventionReportEmail {
	...
	public DataLossPreventionReportEmail() {
	}

	public DataLossPreventionReportEmail(String messageId, String threadId, String historyId, String from, String to, String subject,
